export const postResolvers = {
    post_create: async (parent, { post }, { prisma, userInfo }) => {
    ...
    post_update: async (parent, { postId, post }, { prisma, userInfo }) => {
    ...
    post_delete: async (parent, { postId }, { prisma, userInfo }) => {
        console.log(postId);
        const isExist = await prisma.user.findFirst({
            where: {
                id: userInfo.userId
    ...
    post_publish: async (parent, { postId, post }, { prisma, userInfo }) => {
